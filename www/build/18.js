...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ActivityharvesPageModule", function() { return ActivityharvesPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__activityharves__ = __webpack_require__(323);
...
var ActivityharvesPageModule = /** @class */ (function () {
    function ActivityharvesPageModule() {
    }
    ActivityharvesPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__activityharves__["a" /* ActivityharvesPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__activityharves__["a" /* ActivityharvesPage */]),
            ],
        })
    ], ActivityharvesPageModule);
    return ActivityharvesPageModule;
}());

//# sourceMappingURL=activityharves.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ActivityharvesPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
 ...
 */
var ActivityharvesPage = /** @class */ (function () {
    function ActivityharvesPage(navCtrl, http, Storage, loadingCtrl, navParams, alerCtrl) {
    ...
    ActivityharvesPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad ActivityharvesPage');
    ...
    ActivityharvesPage.prototype.m = function (m) {
        throw new Error("Method not implemented.");
    };
    ActivityharvesPage.prototype.ionViewDidEnter = function () {
        var _this = this;
        var loading = this.loadingCtrl.create({
            content: 'กำลังโหลดข้อมูล'
        });
        loading.present();
        var ob = this.http.get('https://traceability.digitalsmartfarm.com/api/activity_harves.php?cropID=' + this.corpInfo.id);
    ...
    ActivityharvesPage.prototype.saveActivityRice = function (_event, _textdetail1, _textdetail2, _textsequence, _textamount) {
        var data = {
            event: _event,
        ...
        this.http.post('https://traceability.digitalsmartfarm.com/api/savdddharvesrice.php', data)
    ...
    ActivityharvesPage.prototype.showConfirm = function () {
        var _this = this;
    ...
    ActivityharvesPage.prototype.actionConfirm = function () {
        this.http.get('https://traceability.digitalsmartfarm.com/api/saveaddharvesveg.php').subscribe(function (resp) {
            if (resp) {
            }
        });
    };
    ActivityharvesPage.prototype.actionSaveDataSuccess = function () {
    ...
    return ActivityharvesPage;
}());

//# sourceMappingURL=activityharves.js.map
