...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ActivityRicePageModule", function() { return ActivityRicePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__activity_rice__ = __webpack_require__(318);
...
var ActivityRicePageModule = /** @class */ (function () {
    function ActivityRicePageModule() {
    }
    ActivityRicePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__activity_rice__["a" /* ActivityRicePage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__activity_rice__["a" /* ActivityRicePage */]),
            ],
        })
    ], ActivityRicePageModule);
    return ActivityRicePageModule;
}());

//# sourceMappingURL=activity-rice.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ActivityRicePage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(13);
...
var ActivityRicePage = /** @class */ (function () {
    function ActivityRicePage(navCtrl, http, Storage, loadingCtrl, navParams, alerCtrl) {
    ...
    ActivityRicePage.prototype.ionViewDidLoad = function () {
    ...
    ActivityRicePage.prototype.ionViewDidEnter = function () {
        var _this = this;
        var loading = this.loadingCtrl.create({
            content: 'กำลังโหลดข้อมูล'
        });
        loading.present();
        var ob = this.http.get('https://traceability.digitalsmartfarm.com/api/activity_rice.php?crop_id=' + this.corpInfo.id);
    ...
    ActivityRicePage.prototype.saveActivityRice = function (_textdetail1, _textdetail2) {
        var data = {
    ...
    ActivityRicePage.prototype.showConfirm = function () {
        var _this = this;
    ...
    ActivityRicePage.prototype.actionConfirm = function () {
        this.http.get('https://traceability.digitalsmartfarm.com/api/saveactrice.php').subscribe(function (resp) {
            if (resp) {
            }
        });
    };
    ActivityRicePage.prototype.actionSaveDataSuccess = function () {
    ...
    return ActivityRicePage;
}());

//# sourceMappingURL=activity-rice.js.map
