...
@IonicPage()
@Component({
  selector: 'page-activity-veg-food',
  templateUrl: 'activity-veg-food.html',
})
export class ActivityVegFoodPage {
  corpInfo: any;
  v: any;
  textdetail1: any;
  textdetail2: any;
  ...
  ionViewDidEnter() {
    ...
    loading.present();
     let ob = this.http.get('https://traceability.digitalsmartfarm.com/api/activity_food_veg.php?crop_id='+this.corpInfo.id)
  ...
  actionConfirm() {
    this.http.get('https://traceability.digitalsmartfarm.com/api/saveaddfoodveg.php').subscribe((resp) => {
      if (resp) {
