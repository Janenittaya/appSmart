...
@IonicPage()
@Component({
  selector: 'page-activity-veg-compost',
  templateUrl: 'activity-veg-compost.html',
})
export class ActivityVegCompostPage {
  corpInfo: any;
  v: any;
  textdetail1: any;
  textdetail2: any;
  ...
  ionViewDidEnter() {
    ...
    loading.present();
    let ob = this.http.get('https://traceability.digitalsmartfarm.com/api/activity_compost_veg.php?crop_id='+this.corpInfo.id)
    ob.subscribe(
      (data: any) => {
        loading.dismiss();
        this.news = data;
